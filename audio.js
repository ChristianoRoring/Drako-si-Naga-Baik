...
class GameAudio {
  constructor() {
    ...
    this.narratorSpeed = parseFloat(localStorage.getItem("drako_speed_narrator")) !== null && !isNaN(parseFloat(localStorage.getItem("drako_speed_narrator"))) ? parseFloat(localStorage.getItem("drako_speed_narrator")) : 0.7;
