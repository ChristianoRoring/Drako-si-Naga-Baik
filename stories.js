...
window.STORIES_DATA = [
  {
    ...
    pages: [
      ...
      },
      {
        pageNumber: 5,
        background: "linear-gradient(to bottom, #e8f5e9, #ffffff)",
        text: "Drako mengembalikan balon kepada si anak kelinci yang langsung berhenti menangis. Drako lalu bergegas ke jembatan kayu. Ia mendorong batang pohon tumbang dengan sekali dorongan hingga jembatan kembali bersih. Anak-anak bebek pun bisa ke seberang dengan aman.",
